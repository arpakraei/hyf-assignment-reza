  ...
  return (
    <>
      <div className={styles.container}>
        <OurValueCard
          name="Exploration"
          description="We are driven by a deep-seated desire to explore the unknown. We
        ...
        <OurValueCard
          name="Innovation"
          description="At Galactica, we prioritize cutting-edge technology and innovation. We
        ...
        <OurValueCard
          name="Sustainability"
          description="We are committed to making space exploration sustainable for future
        ...
        <OurValueCard
          name="Community"
          description="We believe in the power of collective exploration. Our journeys are
